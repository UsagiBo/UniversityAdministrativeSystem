 ...
 *
 * @author geusa
 * Display Teachers their Subject/s and number of Students
 */
...
public class TeachersServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Object[]> teacherSubStud = tdao.getTeacherSubjectStudentCount();
        request.setAttribute("teacherSubStud", teacherSubStud);
