 ...
 * @author geusa
 */
@WebServlet(name = "NewTeacherServlet", urlPatterns = {"/newteacher"})
public class NewTeacherServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/newteacher.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>New Teacher</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<a href=\"/UniAdminSystem/\" accesskey=\"1\" title=\"\">Back to Home</a>");
            out.println("<h1> The Teacher " + teacher.getName() + " was added to the Univerisy! </h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
