...
public class NewStudentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1> The Student " + student.getName() + " was added to the Univerisy! </h1>");
            out.println("</body>");
            out.println("</html>");
            ...
            out.println("<body>");
            out.println("<a href=\"/UniAdminSystem/\" accesskey=\"1\" title=\"\">Back to Home</a>");
            out.println("<h1> There areonly 4 semester in our programs. Please enter a valid semester andtry again. </h1>");
            out.println("<a href=\"/UniAdminSystem/newstudent\" accesskey=\"1\" title=\"\">Add a new Student</a>");
            out.println("</body>");
            out.println("</html>");
