 ...
 * @author geusa
 */
@WebServlet(name = "StudentsTeachersServlet", urlPatterns = {"/studentsteachers"})
public class StudentsTeachersServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/studentsteachers.jsp").forward(request, response);
    }
